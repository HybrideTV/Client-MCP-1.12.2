...
public class GuiIngame extends Gui
{
    ...
    /* protected void renderKeyStroke() {
     	for(KeyStroke k : EnumKeyStrokeModule.ZQSD_MOUSE.getKeys()) {
     		Gui.drawRect(0 + k.getX(),
     				50 + k.getY(),
     				0 + k.getX() + k.getWidth(),
     				50 + k.getY() + k.getHeight(),
     				k.isPressed() ? new java.awt.Color(255, 255, 255, 100).getRGB() : new java.awt.Color(0, 0, 0, 102).getRGB());

     		int textWidth = getFontRenderer().getStringWidth(k.getName());
     		getFontRenderer().drawString(k.getName(), 0 + k.getX() + k.getWidth() / 2 - textWidth / 2, 50 + k.getY() + k.getHeight() / 2, java.awt.Color.ORANGE.getRGB());
     	}
     }*/
    //FIN DU CODE RENDERGAME

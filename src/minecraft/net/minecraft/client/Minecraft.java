...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        SplashProgress.setProgress(2, "Chargement de optifine");
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.blockColors = BlockColors.init();
        this.itemColors = ItemColors.init(this.blockColors);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager, this.itemColors);
        SplashProgress.setProgress(3, "Chargement du rendu des items 1");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        SplashProgress.setProgress(4, "Chargement des rendus");
        this.itemRenderer = new ItemRenderer(this);
        SplashProgress.setProgress(5, "Chargement du rendu des items 2");
        this.mcResourceManager.registerReloadListener(this.renderItem);
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        SplashProgress.setProgress(6, "Chargement des ressources");
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.blockColors);
        SplashProgress.setProgress(6, "Chargement des rendus des blocs");
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        this.renderGlobal = new RenderGlobal(this);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        SplashProgress.setProgress(7, "Chargement du rendu final");
        this.func_193986_ar();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("StudyCorp Client");
